...
const HomeStack = () => (
    <MainStack.Navigator headerMode={'none'} screenOptions={navigationConfigs} keyboardHandlingEnabled={isIos}>
        ...
        <MainStack.Screen name={TAB_NAVIGATION_ROOT.HOME_ROUTE.NEW_LIST} component={NewsListScreen} />
        <MainStack.Screen name={TAB_NAVIGATION_ROOT.HOME_ROUTE.NEW_DETAIL} component={NewsDetailScreen} />
        ...
        <MainStack.Screen name={TAB_NAVIGATION_ROOT.HOME_ROUTE.EDIT_ORDER} component={EditOrderScreen} />
        <MainStack.Screen
            name={TAB_NAVIGATION_ROOT.HOME_ROUTE.NOTIFICATION_DETAIL}
...
const StampStack = () => (
    <MainStack.Navigator headerMode={'none'} screenOptions={navigationConfigs} keyboardHandlingEnabled={isIos}>
        ...
        <MainStack.Screen name={TAB_NAVIGATION_ROOT.STAMP_ROUTE.EXCHANGE_STAMP} component={ExchangeStampScreen} />
        <MainStack.Screen name={TAB_NAVIGATION_ROOT.STAMP_ROUTE.ACCUMULATION_CARD} component={AccumulationCardScreen} />
    </MainStack.Navigator>
);
const CouponStack = () => (
    <MainStack.Navigator headerMode={'none'} screenOptions={navigationConfigs} keyboardHandlingEnabled={isIos}>
...
const SettingStack = () => (
    <MainStack.Navigator headerMode={'none'} screenOptions={navigationConfigs} keyboardHandlingEnabled={isIos}>
        ...
        />
        <MainStack.Screen
            name={TAB_NAVIGATION_ROOT.SETTING_ROUTE.ORDER_HISTORY_DETAIL}
