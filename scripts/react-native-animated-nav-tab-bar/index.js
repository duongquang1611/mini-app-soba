...
function ResourceSavingScene(_a) {
    var isVisible = _a.isVisible,
        ...
        style = _a.style,
        rest = __rest(_a, ['isVisible', 'children', 'style']);
    // react-native-screens is buggy on web
    if (
        (reactNativeScreens.screensEnabled === null || reactNativeScreens.screensEnabled === void 0
            ? void 0
            : reactNativeScreens.screensEnabled()) &&
        reactNative.Platform.OS !== 'web'
    ) {
        return React__namespace.createElement(
            reactNativeScreens.Screen,
            __assign({ activityState: isVisible ? 2 : 0, style: style }, rest),
            children,
        );
    }
    return React__namespace.createElement(
        reactNative.View,
        {
            style: [
                styles.container,
                reactNative.Platform.OS === 'web' ? { display: isVisible ? 'flex' : 'none' } : null,
                style,
            ],
        ...
        React__namespace.createElement(
            reactNative.View,
            {
                ...
                removeClippedSubviews:
                    ...
                    reactNative.Platform.OS === 'ios' ? !isVisible : true,
                pointerEvents: isVisible ? 'auto' : 'none',
...
var floatingMarginBottom = Styled.css(
    templateObject_1 ||
        (templateObject_1 = __makeTemplateObject(['\n  margin-bottom: ', 'px;\n'], ['\n  margin-bottom: ', 'px;\n'])),
    isIphoneX() ? BOTTOM_PADDING_IPHONE_X : BOTTOM_PADDING,
);
var floatingMarginHorizontal = Styled.css(
    templateObject_2 ||
...
var floatingRoundCorner = Styled.css(
    templateObject_3 ||
        (templateObject_3 = __makeTemplateObject(['\n  border-radius: 40px;\n'], ['\n  border-radius: 40px;\n'])),
);
var BottomTabBarWrapper = Styled__default['default'].View(
    templateObject_4 ||
    ...
    function (p) {
        return p.floating && floatingMarginHorizontal;
    },
    function (p) {
        return p.floating && floatingMarginBottom;
    },
    function (p) {
        return p.floating && floatingRoundCorner;
    },
    function (p) {
        return p.floating ? p.bottomPadding : isIphoneX() ? BOTTOM_PADDING_IPHONE_X + p.bottomPadding : p.bottomPadding;
    },
    function (p) {
        return p.topPadding;
    },
    function (p) {
        return p.horizontalPadding;
    },
    function (p) {
        return p.tabBarBackground;
    },
    function (p) {
        return p.shadow && SHADOW;
    },
);
...
var TabButton = Styled__default['default'].TouchableOpacity(
    templateObject_5 ||
...
var Label = Styled__default['default'](reactNative.Animated.Text)(
    templateObject_6 ||
    ...
    function (p) {
        return p.whenInactiveShow == exports.TabElementDisplayOptions.BOTH ||
            p.whenActiveShow == exports.TabElementDisplayOptions.BOTH
            ? '14px'
            : '17px';
    },
    function (p) {
    ...
    function (p) {
        return (p.whenActiveShow == exports.TabElementDisplayOptions.BOTH ||
            p.whenInactiveShow == exports.TabElementDisplayOptions.BOTH) &&
            p.tabButtonLayout == exports.TabButtonLayout.HORIZONTAL
            ? 8
            : 0;
    },
);
var Dot = Styled__default['default'](reactNative.Animated.View)(
    templateObject_7 ||
    ...
    function (p) {
        return p.dotCornerRadius;
    },
    function (p) {
        return p.activeTabBackground;
    },
);
var SHADOW = Styled.css(
    templateObject_8 ||
...
var TabBarElement = function (_a) {
    var state = _a.state,
        ...
        descriptors = _a.descriptors,
        appearance = _a.appearance,
        tabBarOptions = _a.tabBarOptions,
        lazy = _a.lazy;
    // Appearance options destruction
    var topPadding = appearance.topPadding,
        bottomPadding = appearance.bottomPadding,
        horizontalPadding = appearance.horizontalPadding,
        tabBarBackground = appearance.tabBarBackground,
        activeTabBackgrounds = appearance.activeTabBackgrounds,
        activeColors = appearance.activeColors,
        floating = appearance.floating,
        dotCornerRadius = appearance.dotCornerRadius,
        whenActiveShow = appearance.whenActiveShow,
        whenInactiveShow = appearance.whenInactiveShow,
        dotSize = appearance.dotSize,
        shadow = appearance.shadow,
        tabButtonLayout = appearance.tabButtonLayout;
    var activeTintColor = tabBarOptions.activeTintColor,
    ...
    // State
    var _b = React.useState(horizontalPadding),
        prevPos = _b[0],
        setPrevPos = _b[1];
    var _c = React.useState(prevPos),
        pos = _c[0],
        setPos = _c[1];
    ...
    var _e = React.useState(0),
        height = _e[0],
        setHeight = _e[1];
    var animatedPos = React.useState(function () {
        return new reactNative.Animated.Value(1);
    })[0];
    var _f = React.useState([state.index]),
        loaded = _f[0],
        setLoaded = _f[1];
    React.useEffect(
        function () {
    ...
    reactNative.Dimensions.addEventListener('change', function () {
        if ((isPortrait && !didChangeToPortrait()) || (!isPortrait && didChangeToPortrait())) {
    ...
    var createTab = function (route, routeIndex) {
        ...
        var accessibilityLabel =
            options.tabBarAccessibilityLabel !== undefined
                ...
                ? ''
                      .concat(label, ', tab, ')
                      .concat(routeIndex + 1, ' of ')
                      .concat(state.routes.length)
                : undefined;
        ...
        var onPress = function () {
            ...
            if (!focused && !event.defaultPrevented) {
                navigation.dispatch(
                    __assign(__assign({}, native.CommonActions.navigate(route.name)), { target: state.key }),
                );
            }
        };
        /**
    ...
    return React__default['default'].createElement(
        ...
        React__default['default'].createElement(
            ...
            React__default['default'].createElement(
                reactNativeScreens.ScreenContainer,
                { style: { flex: 1 } },
                state.routes.map(function (route, index) {
                    ...
                    return React__default['default'].createElement(
                        ResourceSavingScene,
                        { key: route.key, isVisible: isFocused, style: reactNative.StyleSheet.absoluteFill },
                        React__default['default'].createElement(
                            reactNative.View,
                            {
        ...
        tabBarVisible &&
            React__default['default'].createElement(
                reactNative.View,
                { pointerEvents: 'box-none', style: floating && overlayStyle },
                React__default['default'].createElement(
                    BottomTabBarWrapper,
                    {
                        style: tabStyle,
                    ...
                    React__default['default'].createElement(Dot, {
                        ...
                        style: reactNative.I18nManager.isRTL
                            ? {
...
var BottomTabNavigator = function (_a) {
    var initialRouteName = _a.initialRouteName,
        backBehavior = _a.backBehavior,
        children = _a.children,
        screenOptions = _a.screenOptions,
        tabBarOptions = _a.tabBarOptions,
        appearance = _a.appearance,
        rest = __rest(_a, [
            'initialRouteName',
    ...
    var _b = native.useNavigationBuilder(native.TabRouter, {
        ...
        state = _b.state,
        descriptors = _b.descriptors,
        navigation = _b.navigation;
